...
parser.add_argument('-path', '--INPUT_PATH', default='./right/', type=str, help='Input Video/Image Path')
...
parser.add_argument('-image', '--IMAGE_FILE', default='cali', type=str, help='Input Image File Name Prefix (eg.: img_raw)')
...
parser.add_argument('-num','--CALIB_NUMBER', default=1, type=int, help='Least Required Calibration Frame Number')
