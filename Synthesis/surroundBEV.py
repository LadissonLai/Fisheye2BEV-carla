...
def main():
    ...
    # ---
    # front = cv2.imread('./data/front/0000000058.png')
    # back = cv2.imread('./data/back/0000000058.png')
    # left = cv2.imread('./data/left/0000000058.png')
    # right = cv2.imread('./data/right/0000000058.png')
    # ---
