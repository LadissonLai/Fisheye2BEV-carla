...
parser.add_argument('-width', default=1920, type=int, help='Camera Frame Width')
parser.add_argument('-height', default=1080, type=int, help='Camera Frame Height')
...
parser.add_argument('-path_k', default='./data/camera_1_K.npy', type=str, help='Camera K File Path')
parser.add_argument('-path_d', default='./data/camera_1_D.npy', type=str, help='Camera D File Path')
